<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="LogicUniv1._1.blackwhite.WebForm2" %>
	...
	<div class="templatemo-container" >
		...
		<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" />
			...
			<div class="tm-right-inner-container">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="EntityDataSource1">
                </asp:GridView>
                
                <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=LogicUnivSystemEntities" DefaultContainerName="LogicUnivSystemEntities" EnableFlattening="False" EntitySetName="item">
